...
import {Code, Gear, House, Pencil} from '@gravity-ui/icons';
import {
    Breadcrumbs,
    Button,
    Dialog,
...
import {AsideHeader, FooterItem, Settings} from '@gravity-ui/navigation';
...
import {type ThemeMode, setThemeMode} from '../store/slices/themeSlice';
...
export function AppLayout() {
    ...
    const {data, config, isRunning, currentSessionId, currentSessionName} = useAppSelector(
        (state) => state.editor,
    );
